...
import com.study.liao.service.impl.StatisticalRulesServiceImpl;
...
class OnlineEditTest {
    ...
    @Autowired
    StatisticalRulesService statisticalRulesService;
    @Test
    void contextLoads() {
    }
    ...
    @Test
    public void processExcelColumnsWithRules(){
        statisticalRulesService.processExcelColumnsWithRules("1652613121");
    }
}
